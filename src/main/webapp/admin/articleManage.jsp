  ...
  <div style="padding: 32px;">
    <table style="width:100%;border-collapse:collapse;background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.06);overflow:hidden;">
      <thead style="background:#f7f7f7;">
        <tr>
          <th style="padding:12px 8px;border-bottom:1px solid #eee;">文章ID</th>
          <th style="padding:12px 8px;border-bottom:1px solid #eee;">标题</th>
          <th style="padding:12px 8px;border-bottom:1px solid #eee;">作者</th>
          <th style="padding:12px 8px;border-bottom:1px solid #eee;">发布时间</th>
...
<script type="module" async src="${pageContext.request.contextPath}/js/admin/articleManage.js"></script>
